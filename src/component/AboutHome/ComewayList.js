...
import styles from './ComewayList.module.css'
import { useNavigate } from 'react-router-dom';
export function ComewayList(){
  ...
  return(
    <div className={styles.head}>
      <div className={styles.headerTag}>
        <h2 className={styles.newItem}>오시는 길</h2>
        <div onClick={()=> navigate("/comeway")} className={styles.moreItem}>
